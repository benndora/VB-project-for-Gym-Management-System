...
Partial Public Class loginDataSet
    ...
    Partial Public Class logintableDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddlogintableRow(ByVal Username As String, ByVal Password As String, ByVal Usertype As String) As logintableRow
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Function FindByUsername(ByVal Username As String) As logintableRow
            Return CType(Me.Rows.Find(New Object() {Username}),logintableRow)
        End Function
    ...
    Partial Public Class logintableRow
        ...
        Public Function IsUsertypeNull() As Boolean
            Return Me.IsNull(Me.tablelogintable.UsertypeColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetUsertypeNull()
            Me(Me.tablelogintable.UsertypeColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace loginDataSetTableAdapters
    ...
    Partial Public Class logintableTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `logintable` WHERE ((`Username` = ?) AND ((? = 1 AND `Password` IS NU"& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `logintable` (`Username`, `Password`, `Usertype`) VALUES (?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `logintable` SET `Username` = ?, `Password` = ?, `Usertype` = ? WHERE ((`U"& _ 
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Gym_management.My.MySettings.Default.loginConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Username, [Password], Usertype FROM logintable"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As loginDataSet.logintableDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As loginDataSet.logintableDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As loginDataSet.logintableDataTable = New loginDataSet.logintableDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As loginDataSet.logintableDataTable) As Integer
        ...
        Public Overridable Function UpdateAll(ByVal dataSet As loginDataSet) As Integer
            ...
            Try 
                ...
                If (Not (Me._logintableTableAdapter) Is Nothing) Then
                    ...
                    Me._logintableTableAdapter.Connection = CType(workConnection,Global.System.Data.OleDb.OleDbConnection)
                    Me._logintableTableAdapter.Transaction = CType(workTransaction,Global.System.Data.OleDb.OleDbTransaction)
            ...
            Finally
                ...
                End If
                If (Not (Me._logintableTableAdapter) Is Nothing) Then
                    Me._logintableTableAdapter.Connection = CType(revertConnections(Me._logintableTableAdapter),Global.System.Data.OleDb.OleDbConnection)
